            ...
            <div className="flex items-center justify-center min-h-[90vh]">
                <div className="w-full max-w-md bg-white p-8 rounded-lg border-[0.1px]">
                    <div className="text-center mb-6">
                        ...
                        <p className="text-gray-500 font-normal font-s">Yuk, lanjutin belajarmu di videobelajar.</p>
                    </div>

                    <form>
                        <div className="mb-4">
                            <label className="block text-gray-700 text-sm font-medium mb-2" for="email">E-Mail <span
                        ...
                        <div className="mb-4 relative">
                            <label className="block text-gray-700 text-sm font-medium mb-2" for="password">Kata Sandi <span
                                className="text-red-500">*</span></label>
                        ...
                        <div className="text-right my-4">
                            <a href="./forgotpassword.html" className="text-sm text-gray-500 hover:text-gray-700">Lupa Password?</a>
                        </div>
                        ...
                        <div className="flex items-center justify-center">
                            <button
                                ...
                                <svg className="mr-2" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
